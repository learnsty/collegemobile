...
<html lang="en">
	<head>
		...
		<link href="<?php echo $dirlocation;?>c_app/views/css/bootstrap.min.css" rel="stylesheet">
		<!--[if lt IE 9]>
			<script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<link href="<?php echo $dirlocation;?>c_app/views/css/styles.css" rel="stylesheet">
	</head>
	<body>
<div class="wrapper">
    <div class="box">
...
<div id="postModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
	...
	<!-- script references -->
		...
		<script src="<?php echo $dirlocation;?>c_app/views/js/scripts.js"></script>
	</body>
</html>