                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <h2>
                            ...
                            <h2>
                                2,160 results found for: <span class="text-navy">“<?php echo $_GET['SearchKeyword'];?>”</span>
                            </h2>
                           
                            <div class="search-form">
                                <form action="#" method="get">
                                    <div class="input-group">
                                        <input type="text" placeholder="Enter search keyword" name="search" class="form-control input-lg">
                            ...
                            <div class="search-result">
                                ...
                                <a href="#">www.inspinia.com/inspinia</a>
                                <p>
