...
<a href="<?php echo $dirlocation.'learn/courseware';?>" class="btn btn-primary" style="margin-bottom:10px">Back</a>
...
<option value="1">Library Catalogue</option>
<option value="2">Skillset</option>
...
<?php while ($grab=mysql_fetch_array($data['myclassroom'][1])){?>
