                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            ...
                            <div class="search-form">
                                <form action="<?php echo $dirlocation;?>learn/classroom/search" method="get">
                            ...
                            <div class="search-result" style="padding-top:0;">
                                <h3><a href="#"><?php echo $grab['classroom_title'];?></a></h3>
                                <a href="#" class="search-link">www.collegemobile.net/learn/classroom/<?php echo $grab['classroom_title'].'_'.$grab['classroom_id'];?></a>
                                
                                <p>
                                    <?php echo $grab['classroom_description'];?>
                                </p>
                            </div>
                            <?php }?>
                            <div class="hr-line-dashed"></div>
