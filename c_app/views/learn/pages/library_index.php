...
$getbooksundercatalogue=$crud->dbselect('courseware','*',"catalogue_id='".$grab['catalogue_id']."'","LIMIT 8"
);			
?>
<?php if($getbooksundercatalogue[2]!=0){?>
...
<h3 class="page-header" style="margin-bottom:3px;text-align:center;border:none;color:#666"><?php echo $grab['catalogue_title'];?></h3>
</div>
<div class="col-lg-9 pull-left">

<?php 
while($grabook=mysql_fetch_array($getbooksundercatalogue[1])){
...
<div class="col-lg-3" style="margin:0;padding:4px;overflow:hidden;">
                   ...
                   <span style="font-family:sans-serif;font-size:11px;color:#666;padding-left:10px"><i class="fa fa-user"></i> <?php echo $getownerdetails[0]['full_name'];?></span>
                        <!-- /.panel-heading -->
                        <div class="panel-body" style="text-align:center;padding:5px 0;margin-bottom:5px">
