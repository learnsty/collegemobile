...
(function(w, d){
    ...
    this.saveDataURL = "http://www.collegemobile.net/scorm/tracking/set"; // URL path to Tracking DB for saving CMI data (AJAX)
    this.collectDataURL = "http://www.collegemobile.net/scorm/tracking/get"; // URL path to Tracking DB for retrieving CMI data (AJAX)
