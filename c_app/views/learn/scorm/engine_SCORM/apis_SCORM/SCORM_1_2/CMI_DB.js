    ...
    var E = $cdvjs.Application.command("emitter"),
	 ...
	 // other definitions...
        ...
        cmiValueTypes = { 
        	...
        	"CMIVocabulary":/^(?:no-credit|credit|no comment|passed|incomplete|resume|ab-initio|contnue,no message|exit,message|continue,message|normal|suspend|browsed|completed|failed|not attempted|logout|browse|review|time-out|(.?))$/,
