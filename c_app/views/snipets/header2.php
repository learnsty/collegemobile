<?php session_start();?>
<nav class="navbar navbar-default" style="background:#0784d3; border:none;color:#fff;border-radius:0;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo $dirlocation;?>" style="color:#fff">Collegemobile</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#" style="color:#fff">Login</a></li>
           <li><a href="#" style="color:#fff">Signup</a></li>
           <li><a href="#" style="color:#fff">Be A Content Provider</a></li>
