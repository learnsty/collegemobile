...
<body class="wp-smartstudy" style="background: url(<?php echo $dirlocation;?>c_app/views/images/login_background3.png) repeat fixed;font-family: 'Raleway', sans-serif;" ng-app="jaraja"  ng-controller="Registration">
...
<div class="wrapper"> 
	...
	<div class="col-lg-12" style="margin-top:">
    	<?php if((!isset($_SESSION['success_registration']))){?>
            ...
            <div class="col-md-4 col-md-offset-4" ng-if="activate == undefined" style="margin-top:50px">
             <h2 style="color:#06C;text-align:center">User Registration</h2>
...
<div class="input-group">
       ...
       <input type="submit" class="btn btn-sm btn-primary btn-block"  ng-disabled="myForm.$invalid" value="Sign Up">
        ...
        <a href="<?php echo $dirlocation;?>login" class="pull-right" style="margin-top:10px">I already have an account</a>  
                    </div>
